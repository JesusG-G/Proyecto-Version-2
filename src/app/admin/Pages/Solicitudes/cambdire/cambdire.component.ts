...
@Component({
  selector: 'app-cambdire',
  templateUrl: './cambdire.component.html',
  styles: [
  ]
})
export class CAMBDIREComponent implements OnInit {
    ...
    this.solicitud=this.fb.group(      
      {
        datos: this.fb.group({
          ...
          tipoSolicitud:['CAMBDIRE',[Validators.required]],
        ...
        CheckBoxs: this.fb.group(
          {
            ...
            CheckBox_8:['',[Validators.required]],
  ...
  guardar(){
    ...
    this.tramite={
      ...
      CheckBox_8:this.solicitud.get('CheckBoxs')?.value.CheckBox_8,
