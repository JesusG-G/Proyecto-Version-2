...
@Component({
  selector: 'app-perfunlot',
  templateUrl: './perfunlot.component.html',
  styles: [
  ]
})
export class PERFUNLOTComponent implements OnInit {
...
tipoSolicitud:['PERFUNLOT',[Validators.required]],
...
CheckBoxs: this.fb.group(
{
  ...
  CheckBox_6:['',[Validators.required]],
...
CheckBox_3:this.solicitud.get('CheckBoxs')?.value.CheckBox_3,
...
CheckBox_6:this.solicitud.get('CheckBoxs')?.value.CheckBox_6,
...
CheckBox_13:this.solicitud.get('CheckBoxs')?.value.CheckBox_13.toString(),
CheckBox_14:this.solicitud.get('CheckBoxs')?.value.CheckBox_14.toString(),
CheckBox_15:this.solicitud.get('CheckBoxs')?.value.CheckBox_15.toString(),
CheckBox_16:this.solicitud.get('CheckBoxs')?.value.CheckBox_16.toString()
}
...
LimpiarFormulario(){
this.solicitud.reset();
this.solicitud.get('datos')?.get('tipoSolicitud')?.setValue('PERFUNLOT');
}
