...
@Component({
  selector: 'app-solsolve',
  templateUrl: './solsolve.component.html',
  styles: [
  ]
})
export class SOLSOLVEComponent implements OnInit {
    ...
    this.solicitud=this.fb.group(      
      {
        datos: this.fb.group({
          ...
          tipoSolicitud:['SOLSOLVE',[Validators.required]],
          ...
          organismo:['',[Validators.required,Validators.minLength(3)]],
          codigoLAE:['',[Validators.required,Validators.minLength(3)]],
        }),
        CheckBoxs: this.fb.group(
          {
            ...
            CheckBox_4:[false,[Validators.required]],
            ...
            CheckBox_10:[false,[Validators.required]],
  ...
  guardar(){
    ...
    this.tramite={
      ...
      organismo:this.solicitud.get('datos')?.value.organismo,
      codigoLAE:this.solicitud.get('datos')?.value.codigoLAE,
    ...
    LimpiarFormulario(){
      this.solicitud.reset();
      this.solicitud.get('datos')?.get('tipoSolicitud')?.setValue('SOLSOLVE');
    }
