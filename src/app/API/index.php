...
$servidor = "localhost"; $usuario = "root"; $contrasenia = ""; $nombreBaseDatos = "proyectodegrado";
...
if(isset($_GET["insertar"])){
    ...
    $contrasena=$data->contrasena;
        if(($Nombres!="")&&($Apellidos!="")&&($CI!="")&&($contrasena!="")){
            
    $sqlRegistro = mysqli_query($conexionBD,"INSERT INTO registro(`Nombres`, `Apellidos`, `CI`, `contraseña`) VALUES ($Nombres,$Apellidos,$CI,$contrasena)");
    echo json_encode(["success"=>1]);
        }
    exit();
}
